...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.PlanProstora", b =>
                {
                    ...
                    b.HasIndex("DogadjajFK")
                        .IsUnique()
                        .HasFilter("[DogadjajFK] IS NOT NULL");
            ...
            modelBuilder.Entity("Backend.Models.AppUserRole", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Korisnik", "Korisnik")
                        .WithOne("UserRole")
                        .HasForeignKey("Backend.Models.AppUserRole", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Backend.Models.PlanProstora", b =>
                {
                    b.HasOne("Backend.Models.Dogadjaj", "Dogadjaj")
                        .WithOne("PlanProstora")
                        .HasForeignKey("Backend.Models.PlanProstora", "DogadjajFK");
