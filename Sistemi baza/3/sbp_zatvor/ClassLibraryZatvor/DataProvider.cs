...
public static class DataProvider
{
    ...
    internal static string VratiTipZatvora(ZatvorskaJedinica z)
    {
    ...
    internal static ZatvorskaJedinica? KreirajZatvorskuJedinicu(ZatvorskaJedinicaBasic zatvorskaJedinica)
    {
    ...
    internal static ZatvorskaJedinica? KreirajZatvorskuJedinicu(string tip, ZatvorskaJedinicaPregled zatvorskaJedinica)
    {
        switch (tip)
        {
            case "Otvorena":
    ...
    internal static ZatvorskaJedinicaBasic? KreirajZatvorskuJedinicuBasic(ZatvorskaJedinica zatvorskaJedinica)
    {
    ...
    public static async Task<Result<bool, ErrorMessage>> DodajTerminPoseteAsync(TerminPoseteBasic terminPoseteBasic, int idZatvorskeJedinice)
    {
        ...
        try
        {
            ...
            {
                return "Ne postoji zatvorska jedinica sa zadatim ID-jem".ToError(404);
            }
    ...
    internal static Zaposleni? KreirajZaposlenog(ZaposleniBasic zaposleni, ISession session)
    {
    ...
    internal static Zaposleni? KreirajZaposlenogAPI(string tipZaposlenog, ZaposleniBasic zaposleni, ISession session)
    {
        Zaposleni? z = null;
    ...
    internal static ZaposleniBasic? KreirajZaposlenogBasicAPI(Zaposleni zaposleni, int idZatvorskeJedinice, string radnoMesto,string tip)
    {
    ...
    internal static string VratiTipZaposlenog(Zaposleni z)
    {
    ...
    public static Result<FirmaPregled?, ErrorMessage> VratiFirmuZatvorenika(int zatvorenikId)
    {
        ...
        try
        {
            ...
            {
                return "Samo zatvorenici iz otvorenih zatvorskih jedinica mogu da rade u firmama!".ToError(406);
            }
