...
public class ZaposleniBasic
{
    ...
    public ZaposleniBasic(string jmbg, string ime, string prezime, DateTime datumObuke, string zanimanje, string strucnaSprema)
    {
        JMBG = jmbg;
        Ime = ime;
        Prezime = prezime;
...
public class ZaposleniPregled
{
    ...
    //public int zatvorskajedinicaid;

    public ZaposleniPregled(string jmbg, string ime, string prezime, DateTime datumObuke, string tipZaposlenog, string zanimanje, string strucnaSprema, string radnoMesto, DateTime datumPocetka)//, int zatvorskaJedinicaID)
    {
        JMBG = jmbg;
        Ime = ime;
        Prezime = prezime;
...
public class ZaposleniAdministracijaBasic : ZaposleniBasic
{
    ...
    public ZaposleniAdministracijaBasic(string jmbg, string ime, string prezime, DateTime datumObuke, string zanimanje, string strucnaSprema) : base(jmbg, ime, prezime, datumObuke, zanimanje, strucnaSprema)
    {
        Zanimanje = zanimanje;
        StrucnaSprema = strucnaSprema;
    }
...
#region IzmeniRadnoMestoDTO

public class IzmeniRadnoMestoDTO
{
    public string ZaposleniJMBG { get; set; }
    public int ZatvorskaJedinicaId { get; set; }
    public string StaroRadnoMesto { get; set; }
...
#region ObrisiRadnoMestoDTO
public class ObrisiRadnoMestoDTO
{
    public string ZaposleniJMBG { get; set; }
    public int ZatvorskaJedinicaId { get; set; }
    public string RadnoMestoNaziv { get; set; }
...
#region ZaposleniIzmenaDTO
public class ZaposleniIzmenaDTO
{
    public string JMBG { get; set; }
    public string Ime { get; set; }
    public string Prezime { get; set; }
