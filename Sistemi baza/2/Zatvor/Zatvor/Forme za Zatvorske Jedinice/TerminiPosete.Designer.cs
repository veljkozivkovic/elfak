...
partial class TerminiPosete
{
    ...
    private void InitializeComponent()
    {
        ...
        gbxLista.Size = new Size(469, 571);
        gbxLista.TabIndex = 0;
        ...
        // listaTermina
        // 
        listaTermina.Columns.AddRange(new ColumnHeader[] { columnHeader1, columnHeader2, columnHeader3, columnHeader4 });
        ...
        listaTermina.Size = new Size(463, 543);
        ...
        gbxTermini.Location = new Point(521, 170);
        ...
        MaximizeBox = false;
        MaximumSize = new Size(708, 647);
        MinimizeBox = false;
        MinimumSize = new Size(708, 647);
        Name = "TerminiPosete";
        Text = "TERMINI ZA POSETE";
