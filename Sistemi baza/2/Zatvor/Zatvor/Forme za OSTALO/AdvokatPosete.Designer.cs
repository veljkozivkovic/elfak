namespace Zatvor.Forme_za_OSTALO
{
    partial class AdvokatPosete
    {
        ...
        private void InitializeComponent()
        {
            ...
            // gbxPosete
            // 
            gbxPosete.Controls.Add(btnDodajPosetu);
            gbxPosete.Controls.Add(btnIzmeniPosetu);
            gbxPosete.Controls.Add(btnObrisiPosetu);
            gbxPosete.Location = new Point(629, 31);
            gbxPosete.Margin = new Padding(3, 4, 3, 4);
            gbxPosete.MaximumSize = new Size(157, 287);
            gbxPosete.MinimumSize = new Size(157, 287);
            gbxPosete.Name = "gbxPosete";
            gbxPosete.Padding = new Padding(3, 4, 3, 4);
            gbxPosete.Size = new Size(157, 287);
            gbxPosete.TabIndex = 1;
